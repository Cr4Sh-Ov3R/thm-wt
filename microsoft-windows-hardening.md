...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-run-sevices-smc.png" alt="TryHackMe Microsoft Windows Hardening Run services.msc"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-startup-type-app-readiness.png" alt="TryHackMe Microsoft Windows Hardening startup-type App Readiness"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-run-regedit.png" alt="TryHackMe Microsoft Windows Hardening Run regedit"/></p>

Une fois l'éditeur de registre ouvert, nous pouvons constater un grand nombre de dossiers existants

<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-registry-editor.png" alt="TryHackMe Microsoft Windows Hardening registry editor"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-find-key-tryhackme.png" alt="TryHackMe Microsoft Windows Hardening find key tryhackme"/></p>

L'éditeur de registre m'affiche donc à l'écran la clef *tryhackme* ainsi que le flag recherché.

<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-registy-editor-tryhackme-flag.png" alt="TryHackMe Microsoft Windows Hardening registry editor tryhackme flag"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-diagnosis-denied.png" alt="TryHackMe Microsoft Windows Hardening Diagnosis denied"/></p>

Ensuite énumérons les fichiers présents dans ce dossier à l'aide de ``dir``.

<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-diagnosis-enum-files.png" alt="TryHackMe Microsoft Windows Hardening diagnosis enum files"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-user-account.png" alt="TryHackMe Microsoft Windows Hardening user account"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-system-and-security.png" alt="TryHackMe Microsoft Windows Hardening System and Security"/></p>

Puis dans la partie *Security and Maintenance* cliquer sur ``> Change User Account Control settings``

<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-user-account-security-settings.png" alt="TryHackMe Microsoft Windows Hardening User Account Security settings"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-manage-another-account.png" alt="TryHackMe Microsoft Windows Hardening Manage another account"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-windows-defender-firewall.png" alt="TryHackMe Microsoft Windows Hardening Windows Defender Firewall"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-windows-defender-firewall-monitoring.png" alt="TryHackMe Microsoft Windows Hardening Windows Defender Firewall - Monitoring"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-hosts-file-tryhack-me-IP.png" alt="TryHackMe Microsoft Windows Hardening hots file - tryhack.me IP"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-physical-address.png" alt="TryHackMe Microsoft Windows Hardening Physical address"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-windows-defender-antivirus.png" alt="TryHackMe Microsoft Windows Hardening Windows Defender Antivirus"/></p>

Puis nous cliquons sur le lien *Manage settings* dans la partie *Virus & threat protection settings*

<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-windows-defender-antivirus-virus-protection-manage-settings.png" alt="TryHackMe Microsoft Windows Hardening Windows Defender Antivirus - virus & protection manage settings"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-windows-defender-antivirus-virus-protection-manage-settings-exclusions.png" alt="TryHackMe Microsoft Windows Hardening Windows Defender Antivirus - virus & protection manage settings exclusions"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-microsoft-office-hardening-flag.png" alt="TryHackMe Microsoft Windows Hardening Microsoft Office Hardening - flag"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-bitlocker-recovery-key-file.png" alt="TryHackMe Microsoft Windows Hardening BitLocker Recovery Key file"/></p>
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-bitlocker-recovery-key.png" alt="TryHackMe Microsoft Windows Hardening BitLocker Recovery Key"/></p>
...
> Vous trouverez la réponse en effectuant les manipulations pour répondre à la question 1.

> Plus d'infos sur la salle [TryHackMe Microsoft Windows Hardening](#room)

***Q3 : Un fichier de sauvegarde est placé sur le Bureau de la VM. Quelle est l'extension du fichier ?***

Il vous suffit de regarder sur le bureau de la VM pour découvrir l'extention du fichier de sauvegarde.
...
<p align="center"><img src="/assets/img/microsoft-windows-hardening/microsoft-windows-hardening-cve-details-cve-2022-32230.png" alt="TryHackMe Microsoft Windows Hardening CVE Details - CVE-2022-32230"/></p>
